...
export default class Carousel extends React.Component {
  componentDidMount() {
    const ownCarouselDom = this.refs.ownCarousel;
  }

  render() {
    return (
      <div id="ownCarousel" className="carousel slide" ref="ownCarousel">
        <ol className="carousel-indicators">
          <li data-target="#ownCarousel" data-slide-to="0" className="active"></li>
          <li data-target="#ownCarousel" data-slide-to="1"></li>
          <li data-target="#ownCarousel" data-slide-to="2"></li>
        </ol>
